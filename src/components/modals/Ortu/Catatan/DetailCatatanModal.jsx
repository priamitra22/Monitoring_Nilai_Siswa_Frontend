                    ...
                    >
                      <div className={`max-w-[80%] ${isFromGuru ? 'order-1' : 'order-2'}`}>
                        <div className="flex items-center gap-2 mb-1">
                          <span
                            className={`text-xs font-medium ${isFromGuru ? 'text-blue-600' : 'text-emerald-600'
                              }`}
                          >
                        ...
                        <div
                          className={`px-4 py-2 rounded-lg ${isFromGuru
                        ...
                        <p
                          className={`text-xs text-gray-500 mt-1 ${isFromGuru ? 'text-left ml-1' : 'text-right mr-1'
                            }`}
                        >
                          {diskusiItem.tanggal || '-'}
                        </p>
